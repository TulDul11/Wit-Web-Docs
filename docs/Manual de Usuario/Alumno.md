...
Para poder iniciar sesión en tu cuenta, debes tener tu usuario y contraseña que fue proveída por tu maestro o persona a cargo, si este no es el caso, por favor, contáctalo para que puedas acceder a tu cuenta.
...
Como técnico no puedes inscribirte a una clase por tu cuenta, solo puedes ser inscrito por un profesor, por lo que si debería salir un curso y no sale, contacta a tu profesor para que se asegure de que estás inscrito.

Como herramienta adicional existe la barra de búsqueda; será útil si tienes muchos cursos inscritos, solo deberás escribir el nombre del curso y saldrán las tarjetas relacionadas.

![Barra de Navegacion](/img/search-bar.png)


#### Navegacion en cursos

Al entrar a un curso, aparecerá una pequeña introducción al mismo. A la derecha estarán las tareas pendientes, junto con su fecha de entrega, a las cuales podrán acceder con un clic.

![Tarea pendiente](/img/Tareas-Hacer.png)
#### Tipos de Módulos
