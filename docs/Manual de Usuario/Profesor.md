...
Si la contraseña o el usuario están mal, aparecerá un error Usuario no encontrado, así que asegúrate de haber escrito bien tus credenciales antes de contactar a un superior.

### 3. Navegación en la Plataforma

#### Pantalla inicial

Como maestro, aparecerán las tarjetas de los cursos que hayas creado, junto con una barra de búsqueda que será útil si tienes muchos cursos. Para utilizarla, solo deberás escribir el nombre del curso y se mostrarán los resultados correspondientes.
...
Una vez que estés en la pantalla de creación de cursos, deberás configurar el curso desde cero, agregando su nombre, código y descripción, junto con los alumnos que formarán parte de la clase.

Los alumnos deberán ser agregados uno por uno en la sección de “Alumnos a Agregar”.
...
![Editar modulo](/img/Editar-Modulo.png)

Para modificar la información que se desplegará en el módulo, tendrás que editar el texto. Además, tendrás la opción de añadir imágenes y previsualizar el módulo antes de guardarlo y publicarlo.

![Editar modulo by Preview](/img/Preview-Modulo.png)

### 4. Juegos y Actividades Interactivas

Para subir tus preguntas al juego tipo quiz, debes seleccionar el módulo a editar. Luego, tendrás la opción de añadirlas en la siguiente sección.

![Agregar Preguntas](/img/Agregar-Preguntas.png)

En esta sección, podrás agregar preguntas presionando el botón correspondiente. Aparecerá la opción de escribir tu pregunta y elegir cuatro posibles respuestas, con una sola correcta. La respuesta correcta será la que esté seleccionada con el círculo azul.

![Preguntas](/img/Preguntas.png)

Una vez que todas tus preguntas estén listas, podrás guardarlas y estarán disponibles para el juego dentro del módulo.
